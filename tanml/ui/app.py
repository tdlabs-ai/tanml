...
# ==========================
# --- Service Helpers (imported from services package) ---
from tanml.ui.services.session import _session_dir
from tanml.ui.services.data import (
    _save_upload,
    _pick_target,
    _normalize_vif,
    _schema_align_or_error,
    _row_overlap_pct,
)
from tanml.ui.services.rule_config import (
    _derive_component_seeds,
    _build_rule_cfg,
)
from tanml.ui.services.validation import _try_run_engine


# --- Components (Renderers, Forms, Pages) ---
from tanml.ui.components.renderers import (
    _render_correlation_outputs,
    _render_regression_outputs,
    tvr_render_extras,
)
